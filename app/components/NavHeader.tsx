  ...
  return (
    ...
    >
      <div className="relative w-full max-w-6xl p-0 sm:py-5">
        ...
        <nav
          className={classNames("border-t sm:border-0 flex-col sm:flex-row justify-center", {
            "hidden sm:flex": !isMenuVisible,
            flex: isMenuVisible,
          })}
        >
        ...
        <button className="absolute top-0 right-0 p-3 sm:p-4">
          <SearchIcon />
        </button>
      </div>
    </div>
